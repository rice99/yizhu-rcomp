...
describe("test Avatar component", () => {
	...
	it("it should render correct size", () => {
		let wrapper = render(<Avatar data-testid='avatar-div avatar-username'></Avatar>);
		let div = wrapper.getByTestId("avatar-div");
		...
		cleanup();
		wrapper = render(<Avatar data-testid='avatar-div avatar-username' size="large"></Avatar>);
		expect(wrapper).toMatchSnapshot();
		...
		cleanup();
		wrapper = render(<Avatar data-testid='avatar-div avatar-username' size="small"></Avatar>);
		div = wrapper.getByTestId("avatar-div");
		...
		cleanup();
		wrapper = render(<Avatar data-testid='avatar-div avatar-username' size="tiny"></Avatar>);
		div = wrapper.getByTestId("avatar-div");
		...
		cleanup();
		wrapper = render(<Avatar data-testid='avatar-div avatar-username' size="medium"></Avatar>);
		div = wrapper.getByTestId("avatar-div");
		expect(div).toHaveStyle(`height:${AvatarSize.medium}px`);
		expect(div).toHaveStyle(`width:${AvatarSize.medium}px`);
		expect(div).toHaveStyle(`line-height:${AvatarSize.medium}px`);
	...
	it("should correct loading", () => {
		...
		cleanup();
		wrapper = render(
			<Avatar data-testid='icon-svg' isLoading username="123" src="/" size="tiny"></Avatar>
		);
		svg = wrapper.getByTestId("icon-svg");
		expect(svg).toBeVisible();
	});
	it("should correct img", () => {
		let wrapper = render(<Avatar data-testid='icon-img' src="www.test.com"></Avatar>);
		...
		cleanup();
		wrapper = render(
			<Avatar data-testid='icon-img' src="www.yehuozhili.xyz" username="yehuozhili"></Avatar>
		);
	...
	it("should render correct username", () => {
		let wrapper = render(<Avatar data-testid='icon-div' username="yehuozhili"></Avatar>);
		expect(wrapper).toMatchSnapshot();
		let div = wrapper.getByTestId("avatar-div");
